...
public class Inference {
    ...
    public static void inferRules(Patient patient) {
        ...
        for (Map.Entry<String, Integer> entry : sortedRecommendations.entrySet()) {
            ...
            switch (entry.getKey()) {
                case "Cardiologist": recommendation.append(" - Cardiologist specializes in diagnosing and " +
                ...
                case "Neurologist": recommendation.append(" - Neurologist specializes in treating diseases " +
                        ...
                        "and treatment.\n");
                case "Otolaryngologist": recommendation.append(" - Otolaryngologist specializes in treating diseases" +
                        ...
                        "and allergologist.\n");
                case "Physiotherapist":  recommendation.append(" - Physiotherapy helps with the management of " +
                ...
                case "Gastroenterologist": recommendation.append(" - Gastroenterologist specializes in treating " +
                ...
                case "Allergologist": recommendation.append(" - Allergologist is trained to prevent, diagnose and " +
                        ...
                        "misdiagnosed.\n");
                case "Endocrinologist": recommendation.append(" - Endocrinologists are experts in glands that are " +
